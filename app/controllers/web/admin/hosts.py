...
class Host_Network_View(View):
    ...
    @login_if_not_authenticated
    def get(self, request, host_slug, network_id):
...
class Host_Network_Create(View):
...
class Host_Volume_View(View):
    ...
    @login_if_not_authenticated
    def get(self, request, host_slug, volume_id):
